...
const incidentesMock = [
  {
    ...
    user_id: "user-001",
    status: "open",
    descricao: "Vários erros de login detectados",
    comentario: "",
  ...
  },
  {
    ...
    user_id: "user-002",
    status: "ack",
    descricao: "Banco não respondeu à última verificação",
  ...
  },
  {
    ...
    user_id: "user-003",
    status: "closed",
    descricao: "Tempo de resposta acima de 5 segundos",
  ...
  },
  {
    ...
    user_id: "user-004",
    status: "open",
    descricao: "Falha ao enviar emails de confirmação",
    comentario: "",
  ...
  },
  {
    ...
    user_id: "user-005",
    status: "ack",
    descricao: "CPU acima de 90% nos servidores",

export function initMocks() {
  const regrasMock = [
    ...
    },
    {
      ...
      hora_inicio: '06:00',
      hora_final: '22:00',
      roles: ['CANAIS DIGITAIS', 'ANALISTA'],
      notificacao: true,
      silenciar: false,
      executar: false,
      data_adiar: null
  ...
  const roles = [
    { id: 'role-001', nome: 'INFRA', descricao: 'Infraestrutura', cor: '#f39c12' },
    { id: 'role-002', nome: 'DEV', descricao: 'Desenvolvimento', cor: '#3498db' },
    { id: 'role-003', nome: 'CANAIS DIGITAIS', descricao: 'Canais Digitais', cor: '#9b59b6' },
    { id: 'role-004', nome: 'ANALISTA', descricao: 'Analista', cor: '#2ecc71' },
    { id: 'role-005', nome: 'BDA', descricao: 'Big Data Analytics', cor: '#e74c3c' },
    { id: 'role-006', nome: 'FINANCEIRO', descricao: 'Financeiro', cor: '#e67e22' },
    { id: 'role-007', nome: 'PLANTONISTA', descricao: 'Plantonista', cor: '#1abc9c' },
    ]
